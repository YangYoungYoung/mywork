...
Page({
  ...
  //結算
  pay() {    if (this.data.totalPrice < this.data.minPrice) {
      return;
    }
  ...
  onLoad: function(options) {
    ...
    let that = this
    let url = "http://192.168.0.128:8082/api/category/25684703562435183/product/list"
    var params = {
    ...
    wx.showLoading({
      ...
      //   wx.hideLoading();
      //   // console.log("返回值是：" + res.data.msg[1].productList[1].count);
      //   that.setData({
      //     // goods: res.data.msg,

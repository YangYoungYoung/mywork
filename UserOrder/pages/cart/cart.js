...
Page({
  ...
  data: {
    ...
    goodsList: {
      ...
      noSelect: true,
      list: [
        { id: 1, name: '新鲜芹菜 半斤', pic: '../images/s5.png', number: 4, price: 1, },
        { id: 2, name: '素米 500g', pic: '../images/s6.png', number: 1, price: 3, },
        { id: 2, name: '素米 500g', pic: '../images/s6.png', number: 1, price: 3,  },
        { id: 2, name: '素米 500g', pic: '../images/s6.png', number: 1, price: 3,  },
        { id: 2, name: '素米 500g', pic: '../images/s6.png', number: 1, price: 3,  },
  ...
  bindAllSelect: function () {
    ...
    console.log("全选‘’‘’‘’‘’‘" + currentAllSelect);
    var list = this.data.goodsList.list;
    if (currentAllSelect) {
      for (var i = 0; i < list.length; i++) {
        var curItem = list[i];
  ...
  toPayOrder: function () {
    ...
    for (var i = 0; i < shopList.length; i++) {
      ...
      if (shopList[i].active) {
        ...
        //订单id是单独传过来的
          ...
          orderResult.push(temp);
          
        }
      }
    }
    //将选择的商品ID传给服务器生成订单
    // let url = "http://192.168.0.128:8082/api/orderItemList"
    // let openId = wx.getStorageSync('openid');
    // // console.log("用户的opnId是："+openId);
    // console.log(orderResult[0].description);
    // var params = {
    ...
    wx.request({
      url: 'http://192.168.0.128:8082/api/orderItemList',
      data:  orderResult,
      method: 'POST',
      header: {
